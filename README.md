About r-feature-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-feature-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4855&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-feature-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-feature` can be installed with `conda`:
...
```
mamba install r-feature
```

It is possible to list all of the versions of `r-feature` available on your platform with `conda`:
...
```
mamba search r-feature --channel conda-forge
```
...
mamba repoquery search r-feature --channel conda-forge

# List packages depending on `r-feature`:
mamba repoquery whoneeds r-feature --channel conda-forge

# List dependencies of `r-feature`:
mamba repoquery depends r-feature --channel conda-forge
```
